...
###Required packages###
echo "You need to install Shovill (Tseemann), e.g. using conda"
...
PATH_input=""
Fw="R1" #Change if your fastQ files are not SampleName_R1.fastq.gz and SampleName_R2.fastq.gz
Rv="R2" #Change if your fastQ files are not SampleName_R1.fastq.gz and SampleName_R2.fastq.gz
...
ass="skesa"
#Resources
cpu=0 #This depends on your hardware configuration!
